 ...
 * Generated at: 2019-10-09 16:39:25 UTC
...
String ccmmHostname  = application.getInitParameter("CCMM_HOSTNAME");
 ...
 if(inService.equals("1")) { 
      ...
      out.write("            <b>This Sample Web Site is configured to use the CCMM Server : <br><font color=\"red\">");
      out.print( ccmmHostname );
      out.write("</font><br>\r\n");
      out.write("            <br>\r\n");
      out.write("            <b>To change the default CCMM Server hostname that is used by the Sample Web Site, Edit the \r\n");
      out.write("               CCMM_HOSTNAME entry in the web.xml file</b>\r\n");
      out.write("            <br><br><br>\r\n");
      out.write("        \r\n");
      out.write("        </td>\r\n");
      out.write("        \r\n");
