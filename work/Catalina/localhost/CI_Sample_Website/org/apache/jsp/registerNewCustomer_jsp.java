 ...
 * Generated at: 2019-10-14 18:26:37 UTC
...
public final class registerNewCustomer_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    long serverTimeMS = serverTime.getMilliseconds();
      ...
      out.write("\r\n");
      out.write("//Update the read-only email textbox to display the username\r\n");
      out.write("function populate_email(form)\r\n");
      out.write("{\r\n");
      out.write("\tform.emailAddress.value=form.username.value;\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function validateRegister(form)\r\n");
      out.write("{\t\r\n");
      out.write("   \r\n");
      ...
      out.write("   }\r\n");
      out.write("\r\n");
      out.write("   if ((form.username.value.indexOf(\"@\") == -1 ) ||\r\n");
      out.write("       (form.username.value.indexOf(\".\") == -1 ))\r\n");
      out.write("   {\r\n");
      out.write("      alert(\"Username must be an e-mail address\");\r\n");
      out.write("      return false;\r\n");
      out.write("   }\r\n");
      out.write("\r\n");
      ...
      out.write("      return false;\r\n");
      out.write("   }\r\n");
      out.write("   if (form.confPassword.value.length == 0)\r\n");
      out.write("   {\r\n");
      out.write("      alert(\"Please Confirm your password\");\r\n");
      out.write("      return false;\r\n");
      out.write("   }\r\n");
      out.write("   if (form.confPassword.value != form.password.value)\r\n");
      out.write("   {\r\n");
      out.write("      alert(\"Passwords do not match. Please re-enter your password\");\r\n");
      out.write("      form.confPassword.value = \"\";\r\n");
      out.write("      form.password.value = \"\";\r\n");
      out.write("      return false;\r\n");
      out.write("   }\r\n");
      out.write("   if (form.firstName.value.length == 0)\r\n");
      out.write("   {\r\n");
      out.write("      alert(\"Please enter a First name\");\r\n");
      out.write("      return false;\r\n");
      out.write("   }\r\n");
      out.write("   if (form.lastName.value.length == 0)\r\n");
      out.write("   {\r\n");
      out.write("      alert(\"Please enter a last name\");\r\n");
      out.write("      return false;\r\n");
      out.write("   }\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("   if (form.phoneNumber.value.length == 0)\r\n");
      out.write("   {\r\n");
      out.write("      alert(\"Please enter a Phone Number\");\r\n");
      out.write("      return false;\r\n");
      out.write("   }\r\n");
      out.write("   \r\n");
 ...
 if(inService.equals("1")) { 
      ...
      out.write("            \r\n");
      out.write("            <form name=\"registerform\" onsubmit=\"return validateRegister(this)\" method=\"POST\" action=\"registerNewCustomer_WSClient.jsp\">\r\n");
      out.write("            \r\n");
      out.write("            <script language=\"javascript\">\r\n");
      out.write("                        \r\n");
      ...
      out.write("            <tr>\r\n");
      out.write("                <td colspan=\"2\" height = \"50\" class=\"bold\">Register a New Customer</td>\r\n");
      out.write("            </tr>            \r\n");
      out.write("            <tr>\r\n");
      out.write("                <td class=\"formlabel\">Title</td>\r\n");
      out.write("                <td><input name=\"title\" size=\"5\" maxlength=\"10\" tabindex=\"1\"></td>                \r\n");
      out.write("            </tr>\r\n");
      out.write("            <tr>\r\n");
      out.write("                <td class=\"formlabel\">First Name</td>\r\n");
      out.write("                <td><input name=\"firstName\" size=\"20\" maxlength=\"50\" tabindex=\"2\">&nbsp;<font class=\"formlabel\" color=\"red\">*</font></td>                \r\n");
      out.write("                <td width=\"20\"></td>\r\n");
      out.write("                <td class=\"formlabel\">Last Name</td>\r\n");
      out.write("                <td><input name=\"lastName\" size=\"20\" maxlength=\"50\" tabindex=\"3\">&nbsp;<font class=\"formlabel\" color=\"red\">*</font></td>                \r\n");
      out.write("            </tr>\r\n");
      out.write("            <tr>\r\n");
      out.write("                <td class=\"formlabel\">Username</td>\r\n");
      out.write("                <td><input name=\"username\" size=\"20\" maxlength=\"50\" onblur=\"populate_email(registerform)\" tabindex=\"4\">&nbsp;<font class=\"formlabel\" color=\"red\">*</font></td>                \r\n");
      out.write("                <td width=\"20\"></td>\r\n");
      out.write("                <td class=\"formlabel\">Password</td>\r\n");
      out.write("                <td><input type=password name=\"password\" size=\"20\" maxlength=\"50\" tabindex=\"5\">&nbsp;<font class=\"formlabel\" color=\"red\">*</font></td>\r\n");
      out.write("            </tr>\r\n");
      out.write("            <tr>\r\n");
      out.write("                <td class=\"formlabel\">Email Address</td>\r\n");
      out.write("                <td><input name=\"emailAddress\" readonly=true size=\"20\" maxlength=\"50\" tabindex=\"6\">&nbsp;<font class=\"formlabel\" color=\"red\">*</font></td>  \r\n");
      out.write("                <td width=\"20\"></td>\r\n");
      out.write("                <td class=\"formlabel\">Confirm Password</td>\r\n");
      out.write("                <td><input type=password name=\"confPassword\" size=\"20\" maxlength=\"50\" tabindex=\"5\">&nbsp;<font class=\"formlabel\" color=\"red\">*</font></td>\r\n");
      out.write("            </tr>\r\n");
      out.write("            <tr><td></td></tr>\r\n");
      out.write("            <tr>\r\n");
      out.write("                <td colspan=\"2\"><hr>Postal Address</td>\r\n");
      out.write("                <td width=\"20\"></td>\r\n");
      out.write("                <td colspan=\"2\"><hr>Phone Number</td>                \r\n");
      out.write("            </tr>\r\n");
      out.write("            <tr><td></td></tr>\r\n");
      out.write("            <tr>\r\n");
      out.write("                <td class=\"formlabel\">Line 1</td>\r\n");
      out.write("                <td><input name=\"line1\" size=\"20\" maxlength=\"50\" tabindex=\"7\"></td>\r\n");
      out.write("                <td width=\"20\"></td>\r\n");
      out.write("                <td class=\"formlabel\">International Code</td>\r\n");
      out.write("                <td><input name=\"intCode\" size=\"5\" maxlength=\"10\" tabindex=\"14\"></td>                \r\n");
      out.write("            </tr>\r\n");
      out.write("            <tr>\r\n");
      out.write("                <td class=\"formlabel\">Line 2</td>\r\n");
      out.write("                <td><input name=\"line2\" size=\"20\" maxlength=\"50\" tabindex=\"8\"></td>\r\n");
      out.write("                <td width=\"20\"></td>\r\n");
      out.write("                <td class=\"formlabel\">Area Code</td>\r\n");
      out.write("                <td><input name=\"areaCode\" size=\"5\" maxlength=\"10\" tabindex=\"15\"></td>                \r\n");
      out.write("            </tr>\r\n");
      out.write("            <tr>\r\n");
      out.write("                <td class=\"formlabel\">Line 3</td>\r\n");
      out.write("                <td><input name=\"line3\" size=\"20\" maxlength=\"50\"  tabindex=\"9\"></td>\r\n");
      out.write("                <td width=\"20\"></td>\r\n");
      out.write("                <td class=\"formlabel\">Number</td>\r\n");
      out.write("                <td><input name=\"phoneNumber\" size=\"15\" maxlength=\"30\" tabindex=\"16\" >&nbsp;<font class=\"formlabel\" color=\"red\">*</font></td>                \r\n");
      out.write("            </tr>\r\n");
      out.write("            <tr>\r\n");
      out.write("                <td class=\"formlabel\">Line 4</td>\r\n");
      out.write("                <td><input name=\"line4\" size=\"20\" maxlength=\"50\" tabindex=\"10\"></td>\r\n");
      out.write("                <td width=\"20\"></td>\r\n");
      out.write("                <td class=\"formlabel\">Type</td>\r\n");
      out.write("                <td><select name=\"phoneType\" tabindex=\"17\">\r\n");
      out.write("                <option value=\"Home\">Home\r\n");
      out.write("                <option value=\"Business\">Business\r\n");
      out.write("                <option value=\"Fax\">Fax\r\n");
      out.write("                <option value=\"Mobile\">Mobile\r\n");
      out.write("                <option value=\"Other\">Other\r\n");
      out.write("               </select></td>\r\n");
      out.write("            </tr>\r\n");
      out.write("            <tr>\r\n");
      out.write("                <td class=\"formlabel\">Line 5</td>\r\n");
      out.write("                <td><input name=\"line5\" size=\"20\" maxlength=\"50\" tabindex=\"11\"></td>\r\n");
      out.write("            </tr>\r\n");
      out.write("            <tr>\r\n");
      out.write("                <td class=\"formlabel\">Zip Code</td>\r\n");
      out.write("                <td><input name=\"zipCode\" size=\"20\" maxlength=\"50\" tabindex=\"12\"></td>\r\n");
      out.write("            </tr>\r\n");
      out.write("            <tr>\r\n");
      out.write("                <td class=\"formlabel\">Country</td>\r\n");
      out.write("                <td><input name=\"country\" size=\"20\" maxlength=\"50\" tabindex=\"13\"></td>\r\n");
      out.write("            </tr>\r\n");
      out.write("            <tr><td></td></tr>\r\n");
      out.write("            <tr>\r\n");
      ...
      out.write("            </tr>       \r\n");
      out.write("            <tr>\r\n");
      out.write("                <td class=\"label\">Login Customer</td>\r\n");
      out.write("                <td><input type=\"checkbox\" name=\"loginCustomer\" checked=\"true\" tabindex=\"18\"></td>               \r\n");
      out.write("            </tr>            \r\n");
      out.write("            <tr>\r\n");
      out.write("                <td><br><br></td>\r\n");
      out.write("                <td><input type=submit value=\"     Register     \" tabindex=\"19\">\r\n");
      out.write("            </tr>            \r\n");
      out.write("            </table>\r\n");
      out.write("            </form>\r\n");
      out.write("        </td>\r\n");
