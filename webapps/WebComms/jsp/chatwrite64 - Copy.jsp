...
<script LANGUAGE="JavaScript">
  ...
  function sendChat()
  {
    ...
    {
	alert("The message cannot be sent as there is no agent active in this conversation.");
    }
    else
    {
  ...
  function callMeBack()
  {
    ...
    if(parent.statuscontrol.document.statusform.inSession.value=="0")
    {
	alert("This option is unavailable as you are not in an active chat session.");
    }
    else
    {
      ...
      if (0 == customerNumber.length)
      {
          ...
          customerNumber = prompt("Please enter your phone number for a callback:", ""); 
      ...
      {
      	 document.chatform.message.value = " Customer requested a callback on: " + customerNumber;
