...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="Javascript:onLoginLoadDo()" style="margin:0px;">
		...
		<table id="webchatLogin" class="popover_window" width="430" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td colspan="2" class="bottom_gradient" height="50" width="100%">
					<div>
					<span id="status" class="webchat_connection_status"><b><font class="status_color">Status: </font>Not Connected</b></span>
					<span class="powered_by">Avaya Aura Contact Center</span>
					</div>
				</td>
